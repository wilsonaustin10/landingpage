...
export default function ContactPage() {
  ...
  useEffect(() => {
    // Only show conversion tracking if we haven't tracked a partial conversion yet
    // AND we haven't tracked a full conversion
    const hasTrackedPartial = sessionStorage.getItem('partialConversionTracked');
    const hasTrackedFull = sessionStorage.getItem('fullConversionTracked');
    
    if (!hasTrackedPartial && !hasTrackedFull) {
  ...
  return (
    <>
      {showConversion && (
        <Script id="partial-conversion-tracking" strategy="afterInteractive">
          {`
